...
public class ClickLocationDataSource : LocationDataSource
{
    ...
    public ClickLocationDataSource(MapView mapView)
    {
        _mapView = mapView;
    ...
    public static ClickLocationDataSource Create(MapView mapView)
    {
        var clickSource = new ClickLocationDataSource(mapView);

        mapView.LocationDisplay.DataSource = clickSource;
        ...
        mapView.GeometryEditor = clickSource.GeometryEditor;
